---
title: VRChat向けイベント共有プラットフォーム『HollowShelfie』開発記
description: 個人開発でVRイベント共有サービスをリリース。Laravel + Vue.js + SSRで構築した技術スタック、競合との差別化戦略、リリース後の反省点など開発を通じて得た知見を共有します。
navigation: true
draft: false
created: 2024-06-05
updated:
...
さまざまなscrap＆buildを重ねtotalだと8ヵ月ほどだと思います。
...
そのため、時間を注いでも良い！と思えるプロダクトでなければ続かないと考え、そういったサービスを作ることを決めました。
