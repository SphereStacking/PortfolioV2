...
<template>
  <div class="container mx-auto px-4 py-8 max-w-7xl">
    <div class="mb-8">
      ...
      <h1 class="text-3xl font-bold mb-2">正規表現テスター</h1>
          ...
          <CardContent>
            <div class="space-y-2 max-h-96 overflow-y-auto">
              <button
                ...
                <div class="font-medium text-sm">{{ commonPattern.name }}</div>
                <div class="text-xs text-muted-foreground">{{ commonPattern.description }}</div>
              </button>
            </div>
          </CardContent>
        </Card>
